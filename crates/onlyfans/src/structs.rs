...
pub struct Subscription {
    ...
    pub tips_min: Option<i64>,
    #[serde(rename = "tipsMax")]
    pub tips_max: Option<i64>,
    ...
    fn from(of_sub: Subscription) -> Self {
        Self {
            ...
            name: SubscriptionName {
                username: of_sub.username.unwrap_or_default(),
...
pub struct SubscribedByData {
    ...
    pub discount_period: Option<i64>,
...
pub struct SubscribedOnData {
    ...
    pub messages_summ: Option<i64>,
    #[serde(rename = "tipsSumm")]
    pub tips_summ: Option<i64>,
    #[serde(rename = "subscribesSumm")]
    pub subscribes_summ: Option<i64>,
    #[serde(rename = "postsSumm")]
    pub posts_summ: Option<i64>,
    #[serde(rename = "streamsSumm")]
    pub streams_summ: Option<i64>,
    #[serde(rename = "totalSumm")]
    pub total_summ: Option<i64>,
    pub subscribes: Vec<Subscribe>,
}
...
pub struct Post {
    ...
    pub posted_at_precise: Option<String>,
    #[serde(rename = "expiredAt")]
    pub expired_at: Option<String>,
